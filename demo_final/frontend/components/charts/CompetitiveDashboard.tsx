...
export function CompetitiveDashboard() {
  const comparisonData = useMemo(() => getCompanyComparison(), [])
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm text-white/90">
              Key Players Comparison - Head and Neck Cancer Drugs Market
            </p>
          </div>
      ...
      <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
        <div className="flex items-center justify-between">
          <div className="text-sm text-gray-600">
            <span className="font-semibold">Market Leader:</span> Hebei Xing Chemical (42% market share)
          </div>
          <div className="text-sm text-gray-600">
