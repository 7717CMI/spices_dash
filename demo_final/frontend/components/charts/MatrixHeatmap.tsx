    ...
    <div className="w-full">
      ...
      <div className="overflow-auto" style={{ maxHeight: height }}>
        <div className="inline-block min-w-full">
          ...
          <div className="flex">
            <div className="w-32 p-2 bg-gray-100 border border-gray-300 font-medium text-sm">
              Geo \ Segment
            </div>
            {matrixData.segments.map(segment => (
              <div
                key={segment}
                className="w-32 p-2 bg-gray-100 border border-gray-300 text-xs font-medium text-center truncate"
                title={segment}
              >
                {segment}
              </div>
          ...
          {matrixData.geographies.map((geo, geoIndex) => (
            <div key={geo} className="flex">
              <div className="w-32 p-2 bg-gray-100 border border-gray-300 font-medium text-sm truncate" title={geo}>
                {geo}
              </div>
