...
export function ChartGroupSelector() {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3">
      <h3 className="text-xs font-semibold text-gray-700 mb-2">Chart View</h3>
          ...
          return (
            <button
              ...
              className={`
                ...
                flex items-center space-x-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1
                ${isSelected 
              ...
              aria-label={`Select ${group.label} chart view`}
              aria-pressed={isSelected}
            >
              <Icon 
                className={`w-3 h-3 flex-shrink-0 ${isSelected ? 'text-white' : 'text-gray-500'}`} 
              />
