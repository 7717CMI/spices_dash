    ...
    <div className="bg-white rounded-lg shadow-sm p-2.5 space-y-2">
      ...
      <div>
        ...
        <div className="flex gap-1 mt-1">
          <button
            ...
            className={`flex-1 px-3 py-1.5 text-sm rounded transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 ${
              filters.dataType === 'value'
                ? 'bg-blue-600 text-white'
                : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
            }`}
            aria-label="Select value data type"
            aria-pressed={filters.dataType === 'value'}
          >
            Value
          </button>
          <button
            ...
            aria-label="Select volume data type"
            aria-pressed={filters.dataType === 'volume'}
          >
            Volume
          </button>
        </div>
      ...
      <div>
        ...
        <select
          ...
          className="w-full px-2 py-1.5 text-sm text-gray-900 border border-gray-300 rounded mt-1 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
      ...
      <div className="space-y-2">
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-2 text-gray-900 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-2 text-gray-900 border border-gray-300 rounded-md mb-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
          ...
          <button
            ...
            className="w-full px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 disabled:bg-gray-300 disabled:text-gray-900 disabled:cursor-not-allowed flex items-center justify-center gap-2 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1"
            aria-label="Add selected segment to filter"
          >
