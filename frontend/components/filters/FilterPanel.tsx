    ...
    <div className="bg-white rounded-lg shadow-lg p-6 space-y-6 sticky top-6">
      ...
      <div className="flex items-center justify-between border-b pb-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-1.5 text-xs bg-gray-100 text-gray-700 rounded hover:bg-gray-200 transition-colors"
      ...
      {/* Filter Summary */}
      <div className="border-t pt-4">
        <h3 className="text-xs font-medium text-gray-700 mb-2">Active Filters</h3>
